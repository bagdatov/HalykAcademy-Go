...
func NewCryptoUseCase(db domain.Repository) domain.UseCase {
...
func (uc *cryptoUseCase) FindUser(ctx context.Context, username, password string) (*domain.User, error) {
...
// so this prevents from sql.ErrorNoRows error.
func (uc *cryptoUseCase) FindWallet(ctx context.Context, requester *domain.User, walletName string) (*domain.CryptoWallet, error) {
...
func (uc *cryptoUseCase) GetUserByID(ctx context.Context, id int) (*domain.User, error) {
...
func (uc *cryptoUseCase) CreateUser(ctx context.Context, u *domain.User) error {
	return uc.db.CreateUser(ctx, u)
}

func (uc *cryptoUseCase) CreateWallet(ctx context.Context, cw *domain.CryptoWallet) error {
	return uc.db.CreateWallet(ctx, cw)
}

func (uc *cryptoUseCase) DeleteUser(ctx context.Context, requester *domain.User, targetID int) error {
...
func (uc *cryptoUseCase) DeleteWallet(ctx context.Context, requester *domain.User, targetWallet string) error {
...
func (uc *cryptoUseCase) StartMine(ctx context.Context, requester *domain.User, walletName string) error {
...
func (uc *cryptoUseCase) StopMine(ctx context.Context, requester *domain.User, walletName string) error {
